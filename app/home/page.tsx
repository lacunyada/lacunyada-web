...
export const metadata = {
  title: "lacunyada | Contemporary Jewelry & Object Design",
  description:
  ...
  return (
    <main className="min-h-screen bg-white text-black font-sans px-6 md:px-16 py-10">
      ...
      <div className="max-w-6xl">
        ...
        {/* H1 SEO (antes era un p, ahora es correcto para Google) */}
        <h1 className="text-3xl md:text-6xl leading-tight mb-10">
          .lacunyada is a research project focused on objects, material exploration and experimental form.
        </h1>

      </div>

      {/* MEDIA SECTION (NO CAMBIA NADA VISUAL) */}
